...
- Placed the "Show X entries" dropdown on top left, below download table button. Previous position: bottom left. Affected pages: /dashboard, /bgpupdates, /hijacks, /hijack
