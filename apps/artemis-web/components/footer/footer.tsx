...
const navigation = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/bgpartemis',
    icon: (props) => (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/FORTH-ICS-INSPIRE/artemis',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
    ...
    return (
      <footer className="bg-gray-100 dark:bg-gray-600 border-t border-gray pt-8">
        <div className="max-w-7xl mx-auto pb-5 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:mt-0 md:order-1 text-base text-left text-gray-400">
